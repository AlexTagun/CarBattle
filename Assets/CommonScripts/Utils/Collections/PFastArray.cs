...
public class PFastArray<T_ElementType> : IEnumerable<T_ElementType>
{
    ...
    //Methods
    //-Construction
    public PFastArray(int inInitialCapacity = kCapacityIncrement) {
        reallocate(inInitialCapacity);
    }

    //-Accessors
    public T_ElementType[] getRawElements() { return _elements; }
    ...
    public void addAll(PFastArray<T_ElementType> inOtherArray) {
